...
namespace BookStore.Controllers
{
    public class CartController : Controller
    {
        ...
        {
            // create a new Cart object and get items from session or
            // restore from cookie and db
            Cart cart = GetCart();

            // create a new view model object with cart info and pass
            // it to the view
        ...
        public RedirectToActionResult Add(int id)
        {
            ...
            { // create a new CartItem object with a default quantity of one.
