...
// CartItem.cs and BookDTO.cs files for more info re: issues with JSON serialization.
{
    public class Cart
    {
        ...
        // when editing, replace quantity value with new one.
        // Used when user edits a cart item and changes its quantity
        ...
        // stores updated cart items and new count in session and
        // persistent cookie (stores smaller DTO in cookie). 
        // If count is zero, removes cart and count from session and cookie
        // (this is so cart badge in navbar disappears 
